...
namespace ModeloDatosProvisorios.Datos
{
    ...
    {
        private static Usuario usu1 = new() { IdUsuario = 1, EsAdmin = true, Email = "usuario1@gmail.com", Password = "usuario1" , Roles = "Administrador" };
        private static Usuario usu2 = new() { IdUsuario = 2, EsAdmin = false, Email = "usuario2@gmail.com", Password = "usuario2" };
        private static Usuario usu3 = new Usuario { IdUsuario = 3, EsAdmin = true, Email = "usuario3@gmail.com", Password = "usuario3" , Roles = "Administrador" };
        private static Usuario usu4 = new Usuario { IdUsuario = 4, EsAdmin = false, Email = "usuario4@gmail.com", Password = "usuario4" };
        private static Usuario usu5 = new Usuario { IdUsuario = 5, EsAdmin = true, Email = "usuario5@gmail.com", Password = "usuario5" , Roles = "Administrador" };
